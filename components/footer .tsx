...
export default function Footer() {
  return (
    <footer className="  ">
      <div
        className="flex justify-center   border-t-8 
       border-[#28656A] lg:px-16 md:px-10 px-5 py-10"
      >
        <div className="w-full   grid grid-cols-1 md:grid-cols-3 place-content-center text-gray-600 text-sm">
          {/* Services */}
      ...
      <div className="flex flex-col items-center not-[]:justify-center">
        ...
        <div className="flex space-x-4 mb-7 text-gray-600">
          {/* Social icons */}
          <Link
            href="https://www.facebook.com/share/15KpKgRLvj/?mibextid=wwXIfr"
            aria-label="Facebook"
          ...
          <Link
            href="https://x.com/smarthivetech?s=21"
          ...
          <Link
            href="https://www.instagram.com/smarthivetech?igsh=NzJ0M2ZpOWxvZmM3&utm_source=qr"
          ...
          <Link
            href="https://www.linkedin.com/company/smarthivetech/"
            aria-label="LinkedIn"
            className="hover:text-teal-600"
          >
            <svg
